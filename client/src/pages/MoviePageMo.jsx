    ...
    >
      ...
      <div>
        <section className="movie-detail relative  flex justify-center items-center xl:pt-[150px]">
          ...
          {movie && (
            <div className="flex flex-col justify-between  xl:flex-row gap-10 z-10 xl:rounded-xl items-center md:w-[70%] w-100% text-white">
              <img
                className="w-[100%] md:w-[411px] md:h-[600px] xl:rounded-xl "
                src={movie.image}
                alt=""
              />
              <div className="w-[850px] flex flex-col xl:gap-[50px] xl:p-[50px] pb-[50px] xl:mt-[10px]">
                <div>
