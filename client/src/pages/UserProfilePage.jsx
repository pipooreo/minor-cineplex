  ...
  return (
    ...
    >
      <section className="w-full bg-BG absolute">
        ...
        {isDesktop ? (
          // Desktop view
          <div className="justify-center items-center lg:items-start lg:justify-start flex-col lg:flex-row lg:gap-[0x] xl:gap-[48px] xl:p-[60px_10px_60px_222px] p-[60px_15px] lg:flex">
